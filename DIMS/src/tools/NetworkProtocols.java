...
public class NetworkProtocols {
	...
	public static final String BOARD_MAIN_RESPOND = "bmres";
		...
		public static final String ADMIN_VIDEO_UPLOAD_RESPOND = "avures";
		public static final String VIDEO_DATA_SEND_NOTIFICATION = "vdsnoti";
		
		public static final String ROOM_NUMBER_MODIFY_REQUEST = "rnmreq";
		public static final String ROOM_NUMBER_MODIFY_RESPOND = "rnmres";
		
		public static final String ADMIN_VIDEO_LIST_REQUEST = "avlreq";
		public static final String ADMIN_VIDEO_LIST_RESPOND = "avlres";		
		
		public static final String ADMIN_VIDEO_DELETE_REQUEST = "avdreq";
		public static final String ADMIN_VIDEO_DELETE_RESPOND = "avdres";	
		
		public static final String MAIN_MESSAGE_REQUEST ="mmreq";
		public static final String MAIN_MESSAGE_RESPOND ="mmreq";		

		public static final String MAIN_SCHEDULE_REQUEST = "msreq123";
		public static final String MAIN_SCHEDULE_RESPOND = "msreq123";		
}